...
public:
    ...
    bool isNormalMap() const {return m_texture_norm != NULL; }

    Texture_abtract* getNormalTex() const { return m_texture_norm; }
    ...
    bool isMedium() const { return m_medium ? true : false; }
...
protected:
    ...
    Texture_abtract *m_texture_norm = nullptr;
